...
const Sidebar = ({ activeTab, onTabChange, unreadMessages, unreadNotifications, onCollapseChange }) => {
    ...
    const navigationItems = [
        ...
        // { key: "profile", icon: User, label: t("nav.profile"), gradient: "from-green-500 to-emerald-600", textColor: "text-green-600 dark:text-green-400", bgColor: "bg-green-100 dark:bg-green-900/30", hoverBg: "group-hover:bg-green-200 dark:group-hover:bg-green-900/50", enabled: false },
