    ...
    return (
        ...
        >
            ...
            <div className="h-full backdrop-blur-xl dark:bg-gray-900  flex flex-col">
                <div className="p-6 flex-shrink-0">
                    ...
                    >
                        <div className="relative group">
                            <div className="w-12 h-12 bg-gradient-to-br from-purple-500 via-purple-600 to-pink-600 rounded-xl flex items-center justify-center transition-all duration-300 group-hover:scale-105">
                                <span className="text-white font-bold text-lg">ES</span>
                                <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                            </div>
                            <motion.div
                                className="absolute -top-1 -right-1 w-4 h-4 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full border-2 border-white dark:border-gray-800"
                                ...
                                >
                                    ...
                                    <div
                                        className={`p-2 rounded-lg transition-all duration-300 ${isActive
                                            ? `${item.bgColor}`
                                            : ` ${item.hoverBg} group-hover:scale-105`
                                            }`}
                                    >
                ...
                >
                    <div className="backdrop-blur-xl bg-white/60 dark:bg-gray-700/60 border border-white/30 dark:border-gray-600/30 rounded-xl p-4">
                        <div className="flex items-center space-x-3">
                            <div className="relative">
                                <Avatar username={user?.username || "Anonymous"} size="md" online={true} />
                                <motion.div
                                    className="absolute -bottom-0.5 -right-0.5 w-4 h-4 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full border-2 border-white dark:border-gray-800"
                                    animate={{ scale: [1, 1.2, 1] }}
                                    transition={{ duration: 2, repeat: Infinity }}
                                />
                            </div>
                        ...
                        <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-200/50 dark:border-gray-600/50">
                            ...
                            <motion.button
                                ...
                                className="flex items-center space-x-2 px-3 py-1.5 text-red-500 hover:text-red-600 hover:bg-red-50/80 dark:hover:bg-red-900/20 rounded-lg transition-all duration-300 group backdrop-blur-sm"
                                title="Đăng xuất"
                            >
