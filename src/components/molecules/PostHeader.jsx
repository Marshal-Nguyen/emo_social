...
const PostHeader = ({
  ...
  // Đảm bảo post.author tồn tại và có username, nếu không thì dùng giá trị mặc định
  const author = {
    username: post.author?.displayName || "Anonymous",
    isOnline: post.author?.isOnline ?? false, // Mặc định false vì API không cung cấp
  };
